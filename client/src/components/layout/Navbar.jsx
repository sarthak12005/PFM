          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`text-sm font-medium transition-all duration-200 px-2 py-1 rounded-md ${
                  isActive(link.path)
          ...
          <div className="px-3 py-4 space-y-2 max-h-96 overflow-y-auto">
            {navLinks.map((link, index) => (
              <Link
                ...
                className={`block px-4 py-3 rounded-lg text-base font-medium transition-all duration-200 touch-manipulation transform hover:scale-105 active:scale-95 ${
                  isActive(link.path)
